...
public class SSHProgressHUD extends Dialog {
	...
	static SSHProgressHUD instance;
	View view;
	TextView tvMessage;
	ImageView ivSuccess;
	ImageView ivFailure;
	...
	public static SSHProgressHUD getInstance(Context context) {
		if (instance == null) {
			instance = new SSHProgressHUD(context);
		}
		return instance;
	}
