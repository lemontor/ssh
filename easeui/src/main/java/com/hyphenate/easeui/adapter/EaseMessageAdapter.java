...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowGoodsInfo;
...
import com.hyphenate.easeui.widget.presenter.EaseChatGoodsImagePresenter;
...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        case TXT:
            ...
            }else if (message.getBooleanAttribute(" ", false)){//自定义消息扩展
				presenter = new EaseChatGoodsImagePresenter();
			}else{
